...
class CreateTodo(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['title'] = forms.CharField(label='Title', error_messages={'required': "Please enter your Title"},
                                               widget=forms.TextInput(attrs={'type': 'text', 'placeholder': 'Please enter your Title...', 'class': 'form-control', 'autocomplete': 'off', 'oninvalid': "this.setCustomValidity('Please enter your Title')", 'oninput': "this.setCustomValidity('')"}))
